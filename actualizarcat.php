<?php
    ...
    $id=$_GET["id"];
    $categorias="SELECT * FROM categoria WHERE idCategoria='$id'";
?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<section align="center">
            ...
            <div class="u-carousel-item u-clearfix u-section-1-2">
                <div class="u-clearfix u-sheet u-sheet-1">
                    ...
                    <h3 class="u-custom-font u-font-montserrat u-text u-text-default u-text-1">Cate<span style="font-weight: 700;"></span>goría<span style="font-weight: 700;"></span></h3>
                    <br>
                    <br>
                    <div class="u-expanded-width u-table u-table-responsive u-table-1">
                        <form id="form1" method="post" action="procesarActCat.php">
                        ...
                        <br>
                    <a href="MODC.php" class="u-active-none u-align-center u-border-hover-palette-2-base u-border-none u-btn u-button-style u-custom-font u-font-montserrat u-hover-none u-palette-1-base u-text-body-color u-btn-2">REGRESAR</a>
                    </form>
                    </div>
